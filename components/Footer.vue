<template>
    <footer class="main-element rel-position normal-element">
        <div class="main-element rel-position accent footer-box">
            ...
            <a class="main-element rel-position clickible n-font footer-element" href="https://github.com/Eli-Sterken/Item-Indexer">Site GitHub Repo</a>
        ...
        <div class="main-element rel-position accent footer-box">
            <p class="main-element rel-position normal-element n-font footer-element">
                ...
                <br><br>
                Made with love (sometimes when i should be sleeping) by Eli Sterken 
            </p>
        </div>
    </footer>
</template>
...
<script setup lang="ts">
    ...
    const hfruifh398y4t9348tyrh34yt3489ty34 = 'MTM0MDU2MzcyMjA5OTIyODcyNA'; // Discord feedback webhook stuff
    const fh3f34tu34tu3490tu4hjrh4389t439th4t = 'WVk1bkhGTUNZOVNCa2RBb1NsWlJGQllkWGtQaFlGYTNuMFF2OGIwNWpxT0JabHlwWFJNSE1hX0FvQ3RCUDladDNmOG8';
                ...
                if(type === 'submit') {
                    const { error } = await useFetch(`https://discord.com/api/webhooks/${atob(hfruifh398y4t9348tyrh34yt3489ty34)}/${atob(fh3f34tu34tu3490tu4hjrh4389t439th4t)}`, {
                        ...
                        body: JSON.stringify({
                            ...
                            "embeds": [
                                {
                                    "title": "New Feedback From Item Indexer",
                                    "description": `New feedback from [Item Indexer](https://item-indexer.pages.dev) has been logged. Feedback message: ${value}`,
                                    "color": 65280,
                                    "author": {
                                        "name": "New Visit",
